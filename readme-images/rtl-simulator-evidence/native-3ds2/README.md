...
These screenshots were captured from `master` (`1e451705aca`) and production commit `d7379d15286` on the existing iOS 18.0 iPhone 12 mini Simulator. The branch was subsequently rebased onto latest `master` (`24b2391ce6a`), whose intervening commit changes only `bitrise.yml`; the rebased production equivalent is `6df03703297`. Both captured builds were launched with:
